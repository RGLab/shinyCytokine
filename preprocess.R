...
## write the files out
saveRDS( dat_prop_melt, file="data/sample_proportions_postProcess.rds" )
saveRDS( d, file="data/indiv_proportions_postProcess.rds" )
saveRDS( d2, file="data/sample_proportions_bg_substracted.rds" )
dat <- dat_prop_melt[ dat_prop_melt$Cytokine %in% cytokines, ]
saveRDS( dat, file="data/sample_proportions_postProcess_noCombo.rds")
